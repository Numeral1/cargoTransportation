...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET,"/api/profile").hasAuthority(UserRole.SYS_ADMIN.name())
                .antMatchers(HttpMethod.PUT,"/api/profile").hasAuthority(UserRole.SYS_ADMIN.name())
                .antMatchers(HttpMethod.PUT,"/api/profile/change-password").hasAuthority(UserRole.SYS_ADMIN.name())
                ...
                .antMatchers(HttpMethod.POST,"/api/cars").hasAuthority(UserRole.SYS_ADMIN.name())
                .antMatchers(HttpMethod.GET,"/api/cars/**").hasAuthority(UserRole.SYS_ADMIN.name())
                .antMatchers(HttpMethod.PUT,"/api/cars/**").hasAuthority(UserRole.SYS_ADMIN.name())
                .antMatchers(HttpMethod.DELETE,"/api/cars").hasAuthority(UserRole.SYS_ADMIN.name())
